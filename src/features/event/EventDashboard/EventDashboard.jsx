...
class EventDashboard extends Component {
    ...
    handleCreateEvent = (newEvent) => {
        ...
        const updatedEvents = [...this.state.events, newEvent]; // spread operator - takes mulitple values of event, adds new events to the state
        this.setState({
    ...
    handleUpdateEvent = (updatedEvent) => {
        this.setState({
            events: this.state.events.map(events => {
